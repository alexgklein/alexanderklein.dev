        ...
        <section className='hidden lg:block p-8 grid grid-cols-12 grid-rows-3 gap-24'>
            ...
            <div className="col-span-12 row-span-1 grid grid-cols-12 gap-4">
                <div className="col-span-8 flex items-center">
                    <p className="w-full text-9xl uppercase font-pp-neue-montreal font-medium tracking-tight">
                        Designing 
                        <br/>
                        Homes With
                    </p>
            ...
            <div className="col-span-12 row-span-1 grid grid-cols-12">
                ...
                <div className="col-span-5">
                    <p className="text-9xl text-left uppercase font-pp-neue-montreal font-medium tracking-tight">
                        People 
                        <br/>
                        At Heart
                    </p>
            ...
            <div className="col-span-12 row-span-1 grid grid-cols-12">
                ...
                <div className="col-span-3">
                    <p className="text-lg text-left font-pp-neue-montreal font-medium w-full text-wrap">
                ...
                <div className="col-span-5">
                    <p className="text-sm text-right uppercase leading-none font-pp-neue-montreal font-medium w-full">
                        (our studio)
                    </p>
                </div>
            </div>
