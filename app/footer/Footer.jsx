...
const Footer = () => {
    return (
        <>
            <footer className="h-screen text-sm p-8 font-bold border-t border-gray-300">
                <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                    ...
                    <div className='col-span-1 order-1 md:order-2'>
                        <div className='flex flex-col items-start justify-start space-y-4'>
                            ...
                            <nav>
                                <ul className="text-5xl tracking-tight space-y-4">
            ...
            <div className="p-8 grid grid-cols-3 items-start uppercase font-medium">
